...
import com.example.pawsagram.MainActivity;
...
public class ComposeFragment extends Fragment {
    ...
    private static final int CAPTURE_IMAGE_ACTIVITY_REQUEST_CODE = 1032;
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (description.isEmpty()){
                    Toast.makeText(getContext(), "The description cannot be empty", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void savePost(ParseUser currentUser, String description, File photoFile) {
        ...
        post.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                if(e!=  null){
                    Log.e(TAG, "Issue saving posts", e);
                    return;
                }
                Toast.makeText(getContext(), "Post was successful", Toast.LENGTH_SHORT);
            }
        });
    }
